    ...
    <div className="mx-auto">
      <Card style={{ width: "20rem", padding: "10px" }}>
        <Card.Img
          ...
          src="https://img.myloview.com/stickers/web-icons-set-web-design-icon-computer-and-mobile-icons-home-phone-website-mail-call-printer-chat-pin-map-person-700-201530656.jpg"
        />
